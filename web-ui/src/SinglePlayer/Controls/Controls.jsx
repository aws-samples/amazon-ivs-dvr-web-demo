...
import '../../Player/Controls/Controls.css';
import { formatTime } from '../../utils';
import { LIVE, VOD, VOD_LOADING_TIMEOUT, VOD_STEP_SIZE } from '../../constants';
import BackToLiveBtn from '../../Player/Controls/BackToLiveBtn';
...
} from '../../hooks/useSinglePlayerSeekBar';
...
const Controls = ({ isLive = true }) => {
  ...
  useEffect(() => {
    ...
    if (
      ...
      seekVodToPos(currentScrubberPosition);
    }
